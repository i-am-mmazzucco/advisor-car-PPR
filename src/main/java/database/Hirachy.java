    ...
    public void insertFakeVehiculos() {
        try {
            String query = "INSERT INTO Vehiculo (tipoVehiculo, marca, modelo, color, año, chasis, patente, precio, imagen, url) "
                    ...
                    + (new Random().nextFloat() * 50000 + 10000) + ", 'imagen2.jpg', 'https://soymotero.net/wp-content/uploads/2023/11/458099_24YMHONDACBR600RR.jpg' FROM DUAL "
                    + "UNION ALL SELECT 'automovil', 'Chevrolet', 'Cruze', 'Blanco', '2023', "
                    + (new Random().nextInt(1000000) + 100000) + ", 'GHI789', "
                    + (new Random().nextFloat() * 50000 + 10000) + ", 'imagen3.jpg', 'https://www.chevrolet.com.ar/content/dam/chevrolet/mercosur/argentina/espanol/index/cars/2019-cruze-premier/colorizer/enero-21/colorizer-branco-summit.jpg' FROM DUAL "
                    ...
                    + (new Random().nextFloat() * 50000 + 10000) + ", 'imagen6.jpg', 'https://autobergidum.com/wp-content/uploads/2019/03/Audi-A4-Avant-2.0-TDI-6.jpg' FROM DUAL "
